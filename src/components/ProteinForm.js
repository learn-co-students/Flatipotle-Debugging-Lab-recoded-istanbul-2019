        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Barbacoa"
              name="protein"
              isChecked={ props.protein.includes('Barbacoa') }
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Steak"
              name="protein"
              isChecked={ props.protein.includes('Steak') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chicken"
              name="protein"
              isChecked={ props.protein.includes('Chicken') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Carnitas"
              name="protein"
              isChecked={ props.protein.includes('Carnitas') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Sofritas"
              name="protein"
              isChecked={ props.protein.includes('Sofritas') }
              onChange={ props.handleChange }
            />

        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              name="toppings"
              isChecked={props.toppings.includes("Mild Hot Sauce")}
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              name="toppings"
              isChecked={props.toppings.includes("Medium Hot Sauce")}
              onChange={props.handleChange}
            />
            <img
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="HOT Hot Sauce"
              name="toppings"
              isChecked={props.toppings.includes("HOT Hot Sauce")}
              onChange={props.handleChange}
            />
            <img
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Corn Salsa"
              name="toppings"
              isChecked={props.toppings.includes("Corn Salsa")}
              onChange={props.handleChange}
            />
            <img
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Sour Cream"
              name="toppings"
              isChecked={props.toppings.includes("Sour Cream")}
              onChange={props.handleChange}
            />
            <img
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Lettuce"
              name="toppings"
              isChecked={props.toppings.includes("Lettuce")}
              onChange={props.handleChange}
            />
            <img
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Guac"
              name="toppings"
              isChecked={props.toppings.includes("Guac")}
              onChange={props.handleChange}
            />
            <img
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Cheese"
              name="toppings"
              isChecked={props.toppings.includes("Cheese")}
              onChange={props.handleChange}
            />
            <img

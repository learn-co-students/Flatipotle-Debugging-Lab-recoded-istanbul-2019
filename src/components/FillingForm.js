        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="White Rice"
              name="fillings"
              isChecked={!!props.fillings.includes('White Rice') }
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Brown Rice"
              name="fillings"
              isChecked={!!props.fillings.includes('Brown Rice') }
              onChange={props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Black Beans"
              name="fillings"
              isChecked={!!props.fillings.includes('Black Beans') }
              onChange={props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Pinto Beans"
              name="fillings"
              isChecked={!!props.fillings.includes('Pinto Beans') }
              onChange={props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              name="fillings"
              isChecked={!!props.fillings.includes('Fajita Veggies') }
              onChange={props.handleChange }
            />
